...
$Url = "https://fs01.ultra.com.vc/s/YW977GjgGQ2woo3/download?path=%2F&files=7zip-x64.exe"
$Nome = "7zip-x64.exe"
...
try {
    ...
    # Instalando
    Start-Process -FilePath $InstallerPath -ArgumentList "/S /D=`"C:\Program Files\7-Zip`"" -Wait -NoNewWindow
