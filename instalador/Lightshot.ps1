...
$Url = "https://fs01.ultra.com.vc/s/YW977GjgGQ2woo3/download?path=%2F&files=lightshot-setup.exe"
$Nome = "lightshot-setup.exe"
...
try {
    ...
    # Instalando
    Start-Process -FilePath $InstallerPath -ArgumentList "/LANG=PORTUGUESE /SILENT /SUPPRESSMSGBOXES" -Wait -NoNewWindow
